...
Within plot species richness averaged `r ave(n_plotspecies$n_plotspecies)` with a median of `r median(n_plotspecies$n_plotspecies)` and ranged `r min(n_plotspecies$n_plotspecies)` to `r max(n_plotspecies$n_plotspecies)`.
